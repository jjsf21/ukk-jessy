					...
					<div class="col mx-auto">
						...
						<div class="card">
                          ...
                          <span>Sign in with Google</span>
									...
									<div class="form-body">
										<form class="row g-3" method="post" action="<?= base_url('/home/aksi_login') ?>">
											<div class="col-12">
												<label for="inputEmailAddress" class="form-label"> Username</label>
												<input name="username" class="form-control" id="inputEmailAddress" placeholder="Enter Username">
											</div>
											<div class="col-12">
										...
										<!-- <a class="collapse-item" href="/home/tambah_pengguna">Daftar Akun</a>
 -->
